 ...
 */
class Hat_BubbleTalker_InputText_GhostParty_Chat_Block extends Hat_BubbleTalker_InputText;

var Hat_HUDMenu_GhostParty_Chat_Block LobbyMenu;
...
function AddCharacter(string s)
{
	...
	if (InStr("1234567890", Result) == INDEX_NONE) return;
